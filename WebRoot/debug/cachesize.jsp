...
<%
		...
		String str = new DataServlet(tagserver,"cachesize").DataGet();		
%>
...
<html>
    ...
    <head>
        ...
        <script type="text/javascript">
			...
			var tagchar = "FaviconHits,RoutingUserSessions,ValidatedDomains," +
				"RoutingUsersCache,MulticastService,RoutingAnonymousUsersCache," +
				"ComponentsSessions,EntityCapabilitiesPendingHashes," +
				"EntityCapabilitiesUsers,LoginFailIp,Roster,SessionsbyHostname," +
				"RemoteUsersExistence,VCard,OfflineMessageCount,DiscoServerItems," +
				"DirectedPresences,ClientSessionInfoCache,FaviconMissess,User," +
				"ConnectionManagersSessions,IncomingServerSessions,PrivacyLists," +
				"RoutingServersCache,pubsubnodes,DiscoServerFeatures," +
				"EntityCapabilities,RoutingComponentsCache";
        	...
        	AmCharts.ready(function () {
				...
				chart.addLabel("10%","20%","<%=tagserver%>","left",10,"#000000","0",true);
    ...
    <body>
        ...
        <small>
        <br>
        <br><a href="/bigview/cachesize.jsp?tagserver=<%=tagserver%>"  target="_blank">more</a>
        </small></div>
        </td>
        </tr>
        </table>
