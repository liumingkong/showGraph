...
<%
	...
	String str = new DataServlet(tagserver,"tcpstat").DataGet();	
%>
...
<html>
    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            AmCharts.ready(function () {
				...
				chart.addLabel("10%","20%","TcpStat:"+"<%=tagserver%>","left",10,"#000000","0",true);
                ...
                graph.title = "avg_size";
                graph.valueField = "avg_size";
                graph.bullet = "round";
                ...
                graph2.title = "sd_size";
                graph2.valueField = "sd_size";
                graph2.bullet = "round";
    ...
    <body>
		...
		<br><%=tagserver%>
		-->
        <br><a href="/bigview/tcpstat.jsp?tagserver=<%=tagserver%>" target="_blank">more</a>   
        </small></div>
        </td>        
        <tr>
        </table>
