...
<html>
    <head>
        ...
        <script type="text/javascript">
            ...
            AmCharts.ready(function () {                
                ...
                chart.startDuration = 0.4;
                chart.zoomOutButton = {
                    backgroundColor: '#000000',
                    backgroundAlpha: 0.15
                };
                chart.balloon.color = "#000000";
				chart.addLabel("10%","15%","TopMem:"+"<%=tagserver%>","left",15,"#000000","0",true);
                ...
                graph1.title = "memFree";
                graph1.valueField = "memFree";
                graph1.bullet = "round";
                ...
                graph1.hideBulletsCount = 3;
                chart.addGraph(graph1);

                var graph2 = new AmCharts.AmGraph();
                graph2.title = "swapUsed";
                graph2.valueField = "swapUsed";
                graph2.bullet = "round";
                ...
                graph3.title = "memVirt";
                graph3.valueField = "memVirt";
                graph3.bullet = "round";
    ...
    <body>
    	...
    	<tr>
    	<td align="center">
    		Server Infomation：<%=tagserver%>--TopMem
    	</td>
    	</tr>
    	</table>
