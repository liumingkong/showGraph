...
<html>
    <head>
		...
		AmCharts.ready(function () {
                ...
                chart.startEffect = ">";
				chart.addLabel("10%","20%","TopPidCpu:"+"<%=tagserver%>","left",10,"#000000","0",true);
    ...
    <body>
    		...
    		<table width=100%>
    		<tr>
			<td valign="top" style="width:98%; height:350px;"><div id="chartdiv" style="width:100%; height: 350px;"></div></td>
			...
			<br>Line:
			<input type="text" style="width:25px" maxlength="4" name="user" value=<%=limitValue%> onkeydown="onlyNum();"/>
			<br>
			<input type="submit" value="go" align="left" style="width:30px"/>
			<a href="/bigview/toppidcpu.jsp?tagserver=<%=tagserver%>" target="_blank">more</a>
			<br>
			</form>
			</small>
			</div> 
